...
#ifndef AMO_IPCMESSAGE_B0AC1E82_E533_4D78_9C83_40A493EC3EE6_HPP__
#define AMO_IPCMESSAGE_B0AC1E82_E533_4D78_9C83_40A493EC3EE6_HPP__
...
namespace amo {
    ...
    static const std::string IPC_CREATE_PIPE_CLIENT	 = "CreatePipeClient";
    
    /*! @brief	直接调用C++或JS. */
    static const std::string IPC_NATIVE_EXECUTE		 = "NativeExecute";
    /*! @brief	同步调用C++或JS. */
    static const std::string IPC_NATIVE_SYNC_EXECUTE = "NativesyncExecute";
    /*! @brief	异步调用C++或JS. */
    static const std::string IPC_NATIVE_ASYNC_EXECUTE = "NativeasyncExecute";
    /*! @brief	通知对方处理同步数据. */
    static const std::string IPC_PROCESS_SYNC_EXECUTE = "ProcesssyncExecute";
    
    
    /*! @brief	默认管道大小. */
    static const int IPCDefaultPipeSize = 2000000;
    
    /*! @brief	渲染进程管道前缀. */
    static const std::string IPCRendererPipePrefix = "render_pipe_name_";
    /*! @brief	主进程管道前缀. */
    static const std::string IPCBrowserPipePrefix = "browser_pipe_name_";
    
    /*! @brief	管道消息头部. */
    static const char IPCPipeMessageHeader = 'a';
    /*! @brief	管道消息尾部. */
    static const char IPCPipeMessageTail = 'z';
    
    // 消息各参数所在位置
    class ipc_args_pos_info {
    public:
        /*! @brief	消息参数的起始位置. */
...
#endif //AMO_IPCMESSAGE_B0AC1E82_E533_4D78_9C83_40A493EC3EE6_HPP__