#ifndef AMO_ASCII_HPP__
#define AMO_ASCII_HPP__
...
namespace amo {
	...
	public:
		...
		static bool is_alpha_number(char c)
		{
	...
	private:
		static int get_char_type_mask(char c)
		{
		...
		static bool char_include_a_all_type_mask(char c, int mask)
		{
